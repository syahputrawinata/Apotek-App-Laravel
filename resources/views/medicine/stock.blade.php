...
<table class="table table-striped table-bordered table-hover">
    ...
    <tbody>
        ...
        <tr>
            <td>{{ $no++ }}</td>
            <td>{{ $item['name'] }}</td>
            <td style="{{ $item['stock'] <= 3 ? 'background-color: red; color: white' : 'background-color: none; color: black' }}">
                {{ $item['stock'] }}
            </td>
        ...
        <div class="modal-content">
            ...
            <form method="POST" id="form-stock">
                <div class="modal-body">
                    ...
                    <div class="mb-3"> <label for="name" class="form-label">Nama Obat :</label>
